...
struct PercentageTests {
	...
	@Test func arithmetics() {
		#expect(1% + 1% == 2%)
		#expect(1% - 1% == 0%)
		#expect(20% / 10% == 200%)
	}

	@Test func arithmeticsDouble() {
		#expect(1% + 1 == 2%)
		#expect(1% - 1 == 0%)
	}

	@Test func arithmeticsMutating() {
		var plus = 1%
		plus += 1%
		#expect(plus == 2%)
	...
	@Test func arithmeticsMutatingDouble() {
		var plus = 1%
		plus += 1
		#expect(plus == 2%)
	...
	@Test func originalValueBeforeIncrease() {
	...
	@Test func originalValueBeforeDecrease() {
	...
	@Test func isWithinStandardRange() {
	...
	@Test func numericExtensionsFloatingPoint() {
	...
	@Test func formatting() {
		if #available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, *) {
			...
			#expect(defaultFormatted.count > 0)
		} else {
	...
	@Test func formattedWithFormatStyle() {
		...
		#expect(formatted5.count > 0)
	}

	// MARK: - Additional comprehensive tests

	@Test func originalValueBeforeIncreaseWithIntegers() {
	...
	@Test func originalValueBeforeDecreaseWithIntegers() {
		// Test BinaryInteger overload  
		#expect(abs(20%.originalValueBeforeDecrease(finalValue: 80) - 100.0) < 0.00001)
		#expect(abs(50%.originalValueBeforeDecrease(finalValue: 50) - 100.0) < 0.00001)
		#expect(abs(25%.originalValueBeforeDecrease(finalValue: 75) - 100.0) < 0.00001)
	...
	@Test func isPercentOfWithIntegers() {
		// Test BinaryInteger overload
		#expect(abs(50%.isPercentOf(50) - 100.0) < 0.00001)
		#expect(abs(25%.isPercentOf(25) - 100.0) < 0.00001) 
	...
	@Test func percentageFromFloatingPoint() {
	...
	@Test func percentageChangeWithIntegers() {
	...
	@Test func edgeCases() {
		...
		let large = Percentage(1000000)
		#expect(large.rawValue == 1000000)
	...
	@Test func protocolConformances() {
	...
	@Test func numericProtocolConformance() {
